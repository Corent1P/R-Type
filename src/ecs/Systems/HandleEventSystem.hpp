...
#define HOVER_ON_BUTTON(state) button->getComponent<RType::HoverEffectComponent>()->setHoverState(state)
#define GET_EVENT getComponent<RType::EventComponent>()->getEvent()
...
namespace RType {
    ...
    class HandleEventSystem: public  RType::ASystem {
        public:
             ...
             *        Also used to process a system effect if two distincts entities are involved in the process.
             *
        ...
        private:
            ...
            /**
             * @brief handle the click to apply the effect of the button, example: return to home page
             *
             * @param button button entity
             * @param window window entity
             */
            void handleHoverOnButton(std::shared_ptr<RType::Entity> button, std::shared_ptr<RType::Entity> window);
