...
namespace RType {
     ...
     */
    class InfoEntityCommand : public ACommand {
        public:
            /**
             * @brief Construct a new InfoEntityCommand object
             *
             ...
             */
            void execute(std::shared_ptr<Client> client, FUNCTION_SEND sendToClient, FUNCTION_SEND sendToAll) override;
    };
}