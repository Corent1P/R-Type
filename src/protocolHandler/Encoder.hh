...
namespace RType {
    ...
    */
    ...
    public:
        ...
        */
        static U_STRING moveEntity(std::uint16_t id,
                                   std::uint16_t x, std::uint16_t y,
        ...
        */
        static U_STRING infoEntity(std::uint16_t id,
        ...
        */
        static U_STRING movePlayer(std::int8_t x,
                                   std::int8_t y);
        ...
        */
        static U_STRING actionPlayer(bool action1,
