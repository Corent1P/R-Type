...
namespace RType {
    ...
    */
    ...
    public:
        ...
        /**
        * @brief Add the number of the packet to the packet
        *
        * @param packet Packet to add the number
        * @param number Number of the packet
        *
        * @return U_STRING Packet with the number
        */
        static U_STRING addPacketNumber(U_STRING &packet, std::uint8_t number);
        ...
        */
        static U_STRING header(const std::uint16_t &size, const unsigned char &type);
        ...
        */
        static U_STRING newEntity(const std::uint8_t &type, const std::uint16_t &id,
        ...
        */
        static U_STRING deleteEntity(const std::uint16_t &id);
        ...
        */
        static U_STRING moveEntity(const std::uint16_t &id,
                                   const std::uint16_t &x, const std::uint16_t &y,
        ...
        */
        static U_STRING infoLevel(const std::uint8_t &level);
        ...
        */
        static U_STRING infoEntity(const std::uint16_t &id, const std::uint8_t &type,
                                   const std::uint16_t &x, const std::uint16_t &y,
                                   const std::uint8_t &rotation,
        ...
        */
        static U_STRING movePlayer(const std::int8_t &x, const std::int8_t &y);
        ...
        */
        static U_STRING actionPlayer(const bool &action1, const bool &action2,
        ...
        */
        static U_STRING ACKMissing(const std::vector<std::uint8_t> &packets);
    };
}
